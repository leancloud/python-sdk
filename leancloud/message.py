...
class Message(object):
    ...
    @classmethod
    def find_by_conversation(cls, conversation_id, limit=None, reversed=None):  # type: (str, Optional[int], Optional[bool]) -> List[Message]
    ...
    @classmethod
    def find_by_client(cls, from_client, limit=None):  # type: (str, Optional[int]) -> List[Message]
        query_params = {}  # type: Dict[str, Any]
    ...
    @classmethod
    def find_all(cls, limit=None):  # type: (Optional[int]) -> List[Message]
        query_params = {}  # type: Dict[str, Any]
        if limit is not None:
            query_params['limit'] = limit
        return list(cls._find(query_params))
